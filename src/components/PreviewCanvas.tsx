...
export const PreviewCanvas: React.FC<PreviewCanvasProps> = ({
  ...
  // Memoize the computationally expensive JSON.stringify dependency hash
  // This prevents high CPU spikes when renderStitchedImage is called frequently
  // during interactive event loops (like mousemove annotations)
